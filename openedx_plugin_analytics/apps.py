...
class CustomPluginAnalyticsConfig(AppConfig):
    default_auto_field = "django.db.models.BigAutoField"
    name = "openedx_plugin_analytics"
    label = "openedx_plugin_analytics"
    verbose_name = "OpenedX Plugin Analytics"
    ...
    plugin_app = {
        ...
        PluginURLs.CONFIG: {
            ProjectType.LMS: {
                ...
                PluginURLs.REGEX: "^openedx_plugin/analytics/",
