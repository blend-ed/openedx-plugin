...
WAFFLE_NAMESPACE = "openedx_plugin_analytics"

ANALYTICS_REPORT = f"{WAFFLE_NAMESPACE}.ANALYTICS_report"
ANALYTICS_REPORT_WAFFLE = WaffleSwitch(ANALYTICS_REPORT, module_name=__name__)
...
def is_ready():
    ...
    """
    try:
        ANALYTICS_REPORT_WAFFLE.is_enabled()
        return True
...
waffle_switches = {
    ANALYTICS_REPORT: is_enabled(ANALYTICS_REPORT_WAFFLE),
}
